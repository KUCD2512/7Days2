...
DZE_DEPLOYABLES_CONFIG = [
	...
	["ItemToolbox",[0,8,2],5,0.99,true,false,false,false,false,true,true,["TT650_Civ"],[],["PartGeneric","PartEngine","PartWheel"],"true"],
	["ItemToolbox",[0,8,2],7,0.1,true,false,false,false,false,true,true,["CSJ_GyroC"],[],["PartVRotor","PartEngine","PartFueltank"],"true"],
