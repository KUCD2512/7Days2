...
_speedLimit = 40; // Speed limit in safe zones. Set to 0 to disable speed limit.
_preventTheft = true; // Prevent vehicles from being stolen by assigning them an owner (this includes gear).
_timer = 5; // Delay ending safe zone protection for this many seconds upon leaving. Set to 0 to disable timer.
