...
#define START_ITEMS "ItemBandage",3,"ItemPainkiller","ItemWaterbottleBoiled","FoodCanSardines"
#define START_ITEMS_HERO1 "ItemBandage",3,"ItemPainkiller","ItemWaterbottleBoiled","FoodCanSardines"
#define START_ITEMS_HERO2 "ItemSepsisBandage",3,"ItemPainkiller","ItemWaterbottleBoiled","15Rnd_W1866_Slug",3,"FoodCanSardines"
#define START_ITEMS_HERO3 "ItemSepsisBandage",3,"ItemPainkiller","ItemWaterbottleBoiled","15Rnd_45ACP_USPSD",4,"FoodCanSardines","FoodMRE"
class_public = [ // These are visible to anyone on the server
	[(localize "str_playerstats_hero")+" Lvl1","Soldier_Bodyguard_AA12_PMC_DZ","HookerW1_DZ",[START_ITEMS_HERO1,"8Rnd_9x18_MakarovSD",3],["MeleeHatchet","Makarov_SD_DZ","ItemMap","ItemToolbox","ItemRadio","NVGoggles"],"School_Bag_DZE1",["8Rnd_9x18_MakarovSD",3],[],0,3000,0,""],
	[(localize "str_playerstats_hero")+" Lvl2","CZ_Special_Forces_GL_DES_EP1_DZ","HookerW4_DZ",[START_ITEMS_HERO2,"17Rnd_9x19_glock17SD",3,"ItemMorphine"],["Winchester1866_DZ","G17_SD_DZ","ItemMap","ItemToolbox","ItemRadio","NVGoggles","ItemKnife"],"GunBag_DZE1",["17Rnd_9x19_glock17SD",3],[],0,5000,0,"MeleeHatchet"],
	[(localize "str_playerstats_hero")+" Lvl3","gsc_military_helmet_wdl_DZ","gsc_military_helmet_wdlW_DZ",[START_ITEMS_HERO3,"50Rnd_57x28_P90SD",4,"ItemMorphine","bloodBagONEG"],["P90_SD_DZ","USP_SD_DZ","ItemGPS","ItemToolbox","ItemRadio","NVGoggles","ItemKnife"],"CzechBackpack_DZE1",[],[],0,8000,0,"MeleeHatchet"],
	[localize "str_playerstats_survivor","Survivor2_DZ","SurvivorW2_DZ",[START_ITEMS,"8Rnd_9x18_Makarov",3],["MeleeBaseballbatNails","Makarov_DZ","ItemMap","ItemToolbox","ItemRadio","NVGoggles"],"Czech_Vest_Pouch_DZE1",[],[],0,0,0]
];
...
spawn_public = call {
	...
	if ((toLower worldName) == "napf") exitwith {
		[
			...
			["Nordstern",[10283,18449,0],0,0],
			["Magden",[10709,17085,0],0,0],
			["Agerifeld",[8845,10935,0],0,0],
			["Ramisbode",[8382,8288,0],0,0],
			["Hirsegg",[10329,14073,0],0,0],
			["Farnen",[13105,6947,0],0,0],
			// Above are defaults
			//["South Airstrip",[18291,1790,0],0,0],
			["Froburg",[16828,3604,0],0,0],			
			["Buckten",[5906,5637,0],0,0],
			["Brienz",[16171,3306,0],0,0],
