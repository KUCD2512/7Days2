...
DZAI_airWeapons = [
	...
	["Helicopter1_Example_Classname","Helicopter2_Example_Classname","Helicopter3_Example_Classname"]
	,
	//Corresponding weapon classnames (Remember: no comma for last entry! Otherwise, separate each string with commas)
	["Helicopter1_Example_Weapon","Helicopter2_Example_Weapon","Helicopter3_Example_Weapon"]
];
