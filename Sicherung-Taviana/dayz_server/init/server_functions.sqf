...
server_crashLoot = compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\server_crashLoot.sqf";
server_medicalSync = {
	...
	// _wounds; //8http://localhost/wordpress/wp-login.php
	// [_legs,_arms]; //9
...
//[] execVM "\AH\AH.sqf";
//Mappen
execVM "\z\addons\dayz_server\map\milbasekameni.sqf";
execVM "\z\addons\dayz_server\map\schwarzmarkt.sqf";
execVM "\z\addons\dayz_server\map\tavianazoo.sqf";
execVM "\z\addons\dayz_server\map\schrottplatz.sqf";
//DZMS+WAI
