...
if (!isDedicated) then {
	...
	DZE_PlotPole = [70,85]; // Radius owned by plot pole [Regular objects,Other plotpoles]. Difference between them is the minimum buffer between bases.
...
DZE_SafeZonePosArray = [[[2382.54,4163.14,0],50],[[7639.03,2088.31,0],50],[[5186.06,7694.74,0],50],[[2834.25,9282.13,0],50],[[4678.09,4084.89,0],50],[[3012.5,7137,0],50]]; // Format is [[[3D POS],RADIUS],[[3D POS],RADIUS]]; Stops loot and zed spawn, salvage and players being killed if their vehicle is destroyed in these zones.
...
DefaultMagazines = ["ItemBandage","ItemBandage","8Rnd_9x18_Makarov","8Rnd_9x18_Makarov","8Rnd_9x18_Makarov","ItemWaterbottleBoiled","FoodCanSardines"];
DefaultWeapons = ["NVGoggles","Makarov_DZ","ItemMap","MeleeBaseBallBat","ItemToolbox"];
