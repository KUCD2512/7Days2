/* GENERAL CONFIG */
WAI_DebugMode = true; // enable debug
...
WAI_CleanRoadKill = true; // clean bodies that are roadkills
WAI_RkDamageWeapon = 100; // percentage of chance a roadkill will destroy weapon AI is carrying
...
WAI_ShareDist = 500; // distance from killed AI for AI to share your rough position
WAI_KillsGain = true; // add kill to bandit/human kill score
WAI_HumanityGain = true; // gain humanity for killing AI
WAI_AddHumanity = 25; // amount of humanity gained for killing a bandit AI - set to 0 to disable
WAI_RemoveHumanity = 25; // amount of humanity lost for killing a hero AI - set to 0 to disable
...
WAI_BanditDogtagChance	= 0; // Chance of a bandit having a dog tag in the gear. From 0 to 1. Default = .20 or 20%
WAI_HeroDogtagChance = 0; // Chance of a hero having a dog tag in the gear. From 0 to 1. Default = .20 or 20%
...
WAI_CleanMissionTime = 40; // time in minutes after a mission is complete to clean mission buildings. Set to -1 to disable mission cleanup. Default: 30 minutes
...
WAI_VehFuel = [20,50]; // fuel inside mission spawned vehicles [min%,max%]
