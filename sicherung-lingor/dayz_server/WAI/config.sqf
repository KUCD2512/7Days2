...
wai_debug_mode		 = true; // enable debug
...
ai_moneyMultiplier	 = 5; //This value is multiplied by 50 to set the max amount of ZSC coins in AI wallets. ex. 200x50=10000 max coins.
...
ai_skill_hard		 = [["aimingAccuracy",0.80],["aimingShake",0.80],["aimingSpeed",0.80],["endurance",1.00],["spotDistance",1.00],["spotTime",0.90],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Hard
ai_skill_medium		 = [["aimingAccuracy",0.60],["aimingShake",0.60],["aimingSpeed",0.60],["endurance",1.00],["spotDistance",1.00],["spotTime",0.80],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Medium
ai_skill_easy		 = [["aimingAccuracy",0.40],["aimingShake",0.50],["aimingSpeed",0.50],["endurance",1.00],["spotDistance",1.00],["spotTime",0.70],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Easy
...
ai_gear0			 = [["ItemBandage","ItemBandage"],["ItemRadio","ItemMachete","ItemCrowbar"]];
ai_gear1			 = [["ItemBandage","ItemSodaPepsi"],["Binocular_Vector"]];
ai_gear2			 = [["ItemDocument","FoodCanFrankBeans","ItemHeatPack"],["ItemToolbox"]];
ai_gear3			 = [["ItemWaterbottle"],["ItemCompass","ItemCrowbar"]];
...
wai_avoid_plots			= 1000; // avoid spawning missions near player plots
...
wai_clean_mission_time	= 45; // time in minutes after a mission is complete to clean mission buildings. Set to -1 to disable mission cleanup. Default: 30 minutes
...
wai_mission_fuel		= [15,60]; // fuel inside mission spawned vehicles [min%,max%]
wai_vehicle_damage		= [10,60]; // damages to spawn vehicles with [min%,max%]
...
ac_timeout					= 300; // If the claimer leaves the mission area he/she has this much time to return - time in seconds
