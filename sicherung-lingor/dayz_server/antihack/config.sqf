...
local _owner = [
["Highlander", "76561197982198403", true, false, true, "Test"],
["Brunhilde", "76561199104741041", true, false, true, "Test"],
["", "76561197980724920", true, false, true, "Test"]
]; //---Add owners here - don't forget commas!

/* ***************** Server Configuration **************** */

local _diag_prefix = "<AH>: "; //---This prefix will appear before all diag_log messages on all clients and the server
...
local _voteplayers = 99; //---Number of players that must be online before a vote can be held.
...
local _chat_prefix = "<AH>: "; //---This prefix will appear before all systemChat messages on clients
...
local _discord = "discord.gg/9yFjdjJDwj"; //---This will be displayed when a player types !discord or /discord in chat. Leave empty to disable
local _teamspeak = "discord"; //---This will be displayed when a player types !teamspeak or /teamspeak in chat. Leave empty to disable
local _website = "www.gaming-fun.de"; //---This will be displayed when a player types !website or /website in chat. Leave empty to disable
...
local _drestart = 240; //---Restart time in minutes (will be used to calculate time till restart on debug monitor)
local _dtext = "www.gaming-fun.de"; //---This text will appear at the bottom of the debug monitor
...
local _speedLimit = 40; //---If greater than 0, speed of vehicles in the safe zone will be limited to this number
local _timer = 5; //---If greater than 0, safe zone protection will remain in affect for this number of seconds after leaving

local _disableWeps = false; //---If true, makes the player drop any weapon listed in _dropWeps while in safe zone
...
local _escTopT = "DayZ Server"; //---Text at the top of the escape menu
local _escTopC = [1,1,1,1]; //---Color of the text at the top of the escape menu

local _escMidT = "Origins Epoch"; //---Text in the middle of the escape menu

local _escLUPT = "Homepage"; //---Lower-upper text of the escape menu
local _escLUPC = [1,1,1,1]; //---Color of the lower-upper text of the escape menu

local _escLBOT = "www.gaming-fun.de"; //---Lower-bottom text of the escape menu
