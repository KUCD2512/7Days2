...
#define DEBUG_MODE true // Adds diagnostic entries to the server rpt
#define CRASH_TIMEOUT 600 // The amount of time it takes for the mission to time out if no players show up
