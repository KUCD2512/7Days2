...
local _lootList = [[5,"ItemGoldBar"],[3,"ItemGoldBar10oz"],[20,"ItemSilverBar"],[10,"ItemSilverBar10oz"]];
...
if (_gems > 0) then {
	for "_i" from 1 to _gems do {
		local _gem = ["ItemTopaz","ItemObsidian","ItemSapphire","ItemAmethyst"] call BIS_fnc_selectRandom;
